...
void pcodevhw(){ // begin 
 ...
 s[3] = 0;
  ...
  //MAIN
    ...
    code[ 2].f = STO; code[ 2].l = 0; code[ 2].a =  3; // n = 4
    code[ 3].f = LOD; code[ 3].l = 0; code[ 3].a =  3; 
    code[ 4].f = STO; code[ 4].l = 0; code[ 4].a =  8; // t+3; // passing the parameter

    code[ 5].f = CAL; code[ 5].l = 0; code[ 5].a =  9; //chamando a funcao fat()

    code[ 6].f = LOD; code[ 6].l = 0; code[ 6].a =  9; //GET do main
    code[ 7].f = STO; code[ 7].l = 0; code[ 7].a =  4; // resultado = fat(4)
  ...
  //FAT()
    ...
    code[11].f = STO; code[11].l = 0; code[11].a =  4; // resultado = 1
    code[12].f = LIT; code[12].l = 0; code[12].a =  1;
    code[13].f = STO; code[13].l = 0; code[13].a =  5; // contador = 1

    //for(int contador=1; contador<=n; contador++)
    code[14].f = LOD; code[14].l = 0; code[14].a =  5; // push(contador)
    code[15].f = LOD; code[15].l = 0; code[15].a =  3; // push(n)
    code[16].f = OPR; code[16].l = 0; code[16].a =  12; // push(contador>n)
    code[17].f = JPC; code[17].l = 0; code[17].a = 27; // go to END
    ...
    //contador = contador + 1
    code[22].f = LOD; code[22].l = 0; code[22].a =  5; // push(n)
    code[23].f = LIT; code[23].l = 0; code[23].a =  1; // push(1)
    code[24].f = OPR; code[24].l = 0; code[24].a =  2; // push(n+1) 
    code[25].f = STO; code[25].l = 0; code[25].a =  5; 
    
    code[26].f = JMP; code[26].l = 0; code[26].a =  14; 

    code[27].f = OPR; code[27].l = 0; code[27].a =  0; // RETURN // soma-FIM
