...
void pcodevhw(){ // begin 
 ...
 s[3] = 0;
  ...
  code[4].f = LOD; code[4].l = 0; code[4].a = 7;
  ...
  code[10].f = OPR; code[10].l = 0; code[10].a = 8;
  code[11].f = JPC; code[11].l = 0; code[11].a = 24;

  // else
  code[12].f = LOD; code[12].l = 0; code[12].a = 3;
  code[13].f = LIT; code[13].l = 0; code[13].a = 1;
  code[14].f = OPR; code[14].l = 0; code[14].a = 3;
  code[15].f = STO; code[15].l = 0; code[15].a = 8;
  code[16].f = CAL; code[16].l = 0; code[16].a = 7;
  
  code[17].f = LOD; code[17].l = 0; code[17].a = 8;
  code[18].f = LOD; code[18].l = 0; code[18].a = 9;
  code[19].f = OPR; code[19].l = 0; code[19].a = 2;
  code[20].f = STO; code[20].l = 0; code[20].a = 4;
  code[21].f = LOD; code[21].l = 0; code[21].a = 9;
