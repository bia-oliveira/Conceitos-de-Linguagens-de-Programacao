  ...
  void interpretacao(){
      ...
      fprintf(arquivo, "inst:\tp:\t\tb:\t\tt:\t\ts[1]:\t\ts[2]:\t\ts[3]:\t\ts[4]:\t\ts[5]:\t\ts[6]:\t\ts[7]: \n");
      fprintf(arquivo, "=============================================================================================================\n");
      ...
      do {
        ...
        fprintf(arquivo,"%s\t\t%d\t\t\t%d\t\t\t%d",nomes_instrucoes[i.f], p, b, t);
        for (int j = 1; j <= t; j++) {
            fprintf(arquivo, "\t\t  %lld\t",s[j]);
        }

        fprintf(arquivo, "\n");
      } while (p != 0);

    fprintf(arquivo, "Fim PL/0\n");
    fclose(arquivo);
  }
