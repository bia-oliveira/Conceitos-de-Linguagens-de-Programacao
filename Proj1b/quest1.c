  ...
  instruction code[cxmax + 1] = {{INT, 0, 5}, //Reserva espaço na pilha para 4 variáveis locais
                                 {LIT, 0, 1}, // Empilha o valor 1
                                 {STO, 0, 3}, // Armazena o valor 1 na variável 3          
                                 {LIT, 0, 1}, // Empilha o valor 1
                                 {STO, 0, 4}, // Armazena o valor 1 na variável 4        
                                 ...
                                 {LIT, 0, 10}, // Empilha o valor 10
                                 {LOD, 0, 3}, // Carrega o valor da variável 3 no topo da pilha
                                 {OPR, 0, 3}, // Realiza a operação de subtracao
                                 {JPC, 0, 18}, // Pula para a linha 18
