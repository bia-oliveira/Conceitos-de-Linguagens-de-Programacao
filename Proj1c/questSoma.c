...
int main(){
  ...
  //funcao "soma"
  code[1].f = INT; code[1].l = 0; code[1].a = 7; //rezerva espaco para as variaveis locais da funcao soma
  code[2].f = LOD; code[2].l = 0; code[2].a = 4; //carrega o parametro 1
  code[3].f = LOD; code[3].l = 0; code[3].a = 5; //carrega o parametro 2
  code[4].f = OPR; code[4].l = 0; code[4].a = 2; //soma os parametros
  ...
  code[15].f = STO; code[15].l = 0; code[15].a = 11; //passa o primeiro parametro para a funcao soma 
  code[16].f = LOD; code[16].l = 0; code[16].a = 5;
  code[17].f = STO; code[17].l = 0; code[17].a = 12; //passa o segundo parametro para a funcao soma 
  code[18].f = CAL; code[18].l = 0; code[18].a = 1; //chama a funcao soma
