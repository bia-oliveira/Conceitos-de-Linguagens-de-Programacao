...
int main(){
  ...
  code[0].f = JMP; code[0].l = 0; code[0].a = 9; //"chama a função main"
  //funcao "multi"
  code[1].f = INT; code[1].l = 0; code[1].a = 7; //rezerva espaco para as variaveis locais da funcao multi
  code[2].f = LOD; code[2].l = 0; code[2].a = 4; //carrega o parametro 1
  code[3].f = LOD; code[3].l = 0; code[3].a = 5; //carrega o parametro 2
  code[4].f = OPR; code[4].l = 0; code[4].a = 4; //multiplica os parametros
  code[5].f = STO; code[5].l = 0; code[5].a = 6; //salva o resultado na variavel local "resultado"
  code[6].f = LOD; code[6].l = 0; code[6].a = 6; 
  code[7].f = STO; code[7].l = 1; code[7].a = 6; //salva o resultado na variavel local "resultado" DO MAIN
  code[8].f = OPR; code[8].l = 0; code[8].a = 0;
  //funcao "main"
  code[9].f = INT; code[9].l = 0; code[9].a = 7; //rezerva espaco para as variaveis locais do main
  code[10].f = LIT; code[10].l = 0; code[10].a = 5;
  code[11].f = STO; code[11].l = 0; code[11].a = 4; //a = 5
  code[12].f = LIT; code[12].l = 0; code[12].a = 3;
  code[13].f = STO; code[13].l = 0; code[13].a = 5; //b = 3
  code[14].f = LOD; code[14].l = 0; code[14].a = 4;
  code[15].f = STO; code[15].l = 0; code[15].a = 11; //passa o primeiro parametro para a funcao multi 
  code[16].f = LOD; code[16].l = 0; code[16].a = 5;
  code[17].f = STO; code[17].l = 0; code[17].a = 12; //passa o segundo parametro para a funcao multi 
  code[18].f = CAL; code[18].l = 0; code[18].a = 1; //chama a funcao multi
